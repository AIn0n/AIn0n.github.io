...
[[https://www.linkedin.com/posts/svpino_yesterday-i-spoke-with-a-developer-who-stopped-activity-7420095436134170624-B49o?utm_source=share&utm_medium=member_desktop&rcm=ACoAADjahVMBxA4EKJ9zR5SEPHk8v_XCHb-MTN4][maintainers]]. This mobilized me to dive deep and check how the LLMs have
...
make it possible for them to use it. The best-known case is [[https://www.maggieoates.com/blog/json-and-good-not-evil/][IBM]], when
...
call today a *Code of Conduct*. It's based on [[https://en.wikipedia.org/wiki/Rule_of_Saint_Benedict][teachings]] of the
...
[[https://www.theregister.com/2018/10/22/sqlite_code_of_conduct/][public outcry on Twitter]]. The *authors decided back then to rename it*
from /code of conduct/ to [[https://sqlite.org/codeofethics.html][code of ethics]]. I didn't find any statistics
...
maintainers  and users. It's one of the [[https://db-engines.com/en/ranking_trend][most popular database engines]]
